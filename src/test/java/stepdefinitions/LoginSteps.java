...
public class LoginSteps {
    ...
    public void user_verifies_log_in_is_visible_on_the_page() {
    ...
    public void user_provides_correct_employee_email_and_password(){
        loginPage.login(ConfigReader.readProperty("employee_emailAddress"),ConfigReader.readProperty("employee_password") );
    }
